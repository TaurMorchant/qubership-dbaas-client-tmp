...
public class MongoTestContainer extends GenericContainer<MongoTestContainer> {
    public static final String RYUK_CONTAINER_IMAGE_PROPERTY = "ryuk.container.image";
    public static final String RYUK_CONTAINER_IMAGE = "testcontainers/ryuk:0.11.0";

    public static final String IMAGE_VERSION = "mongo:7.0";
